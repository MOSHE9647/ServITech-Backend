...
class ArticleCreateTest extends TestCase
{
    ...
    public function test_category_id_must_be_required(): void
    {
        ...
        $response->assertJsonFragment([
            'status' => 422,
            'message' => __('validation.required', [
                'attribute' => __('messages.entities.category.singular'),
            ]),
        ]);
    }
    ...
    public function test_subcategory_id_must_be_required(): void
    {
        ...
        $response->assertJsonFragment([
            'status' => 422,
            'message' => __('validation.required', [
                'attribute' => __('messages.entities.subcategory.singular'),
            ]),
        ]);
    }
